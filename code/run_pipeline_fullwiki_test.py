...
def main():
    ...
    # 2. Run KG2RAG Fullwiki
    print("=== Step 2: Running KG2RAG Fullwiki pipeline ===")
    os.makedirs('output/hotpot', exist_ok=True)
    run_command([
        sys.executable, 'kg_rag_full.py',
        '--data_path', '../data/hotpotqa/hotpot_dev_distractor_test.json',
        '--kg_dir', '../data/hotpotqa/kgs/extract_subkgs',
        '--result_path', '../output/hotpot/hotpot_dev_fullwiki_test_kgrag.json',
        '--persist_dir', '../data/ollama_index/hotpotqa_fullwiki_test',
        '--model_name', 'llama3.2',
        '--top_k', '10'
    ], cwd='code')
